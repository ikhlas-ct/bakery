...
@section('title', 'Edit Admin – ' . $admin->nama)
...
<div class="container">
    ...
    <div class="ph-card">
        <div class="ph-left">
            ...
            <div>
                <h5 class="ph-title">Edit Admin</h5>
                <ol class="ph-breadcrumb">
                    <li><a href="{{ route('pemilik.dashboard') }}">Dashboard</a></li>
                    <li><a href="{{ route('pemilik.admin.index') }}">Admin</a></li>
                    <li><a href="{{ route('pemilik.admin.show', $admin->id) }}">{{ $admin->nama }}</a></li>
                    <li><span class="bc-active">Edit</span></li>
                </ol>
            </div>
        </div>
        <div class="d-flex gap-2">
            <a href="{{ route('pemilik.admin.show', $admin->id) }}" class="btn btn-primary btn-sm">
    ...
    <div class="page-inner">
        <form action="{{ route('pemilik.admin.update', $admin->id) }}" method="POST"
                                    ...
                                    <div class="status-box w-100">
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" role="switch"
                                                ...
                                                {{ old('is_active', $admin->user->is_active) ? 'checked' : '' }}>
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nip"
                                        ...
                                        value="{{ old('nip', $admin->nip) }}" placeholder="Nomor Induk Pegawai (opsional)">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="no_telp"
                                            ...
                                            value="{{ old('no_telp', $admin->no_telp) }}" required>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="card shadow-sm mb-4">
                        <div class="card-body text-center">
                            ...
                            <div class="foto-preview-wrap mx-auto mb-3" id="foto-wrap"
                                ...
                                <img id="foto-preview"
                                    src="{{ $admin->user->foto_profil ? asset('storage/' . $admin->user->foto_profil) : asset('user/img/default-avatar.png') }}"
                                    onerror="this.src='https://ui-avatars.com/api/?name={{ urlencode($admin->nama) }}&background=e9ecef&color=6c757d&size=130'"
                                    alt="Preview Foto">
                            </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <a href="{{ route('pemilik.admin.show', $admin->id) }}" class="btn btn-outline-secondary w-100">
                                Batal
                            </a>
                        </div>
                    </div>
