...
<div class="container">
    ...
    <div class="ph-card">
        <div class="ph-left">
            ...
            <div>
                <h5 class="ph-title">Tambah Produsen</h5>
    ...
    <div class="page-inner">
        <form action="{{ route($routePrefix . '.store') }}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="nama_produsen"
                                        ...
                                        value="{{ old('nama_produsen') }}" placeholder="Nama produsen / supplier" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="status_mitra"
                                        ...
                                        <option value="aktif" {{ old('status_mitra') === 'aktif' ? 'selected' : '' }}>Aktif</option>
                                        <option value="nonaktif" {{ old('status_mitra') === 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                                    </select>
                        ...
                        <div class="card-body text-center">
                            ...
                            <div class="foto-preview-wrap mx-auto mb-3" id="foto-wrap"
                                ...
                                <img id="foto-preview"
                                    ...
                                    onerror="this.src='https://ui-avatars.com/api/?name=Produsen&background=e9ecef&color=6c757d&size=130'"
                                    alt="Preview Foto">
                            </div>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            <button type="submit" class="btn btn-primary w-100 mb-2">
                                <i class="fas fa-save me-2"></i> Simpan Produsen
                            </button>
                            <a href="{{ route($routePrefix . '.index') }}" class="btn btn-outline-secondary w-100">
                                Batal
                            </a>
                        </div>
                    </div>
