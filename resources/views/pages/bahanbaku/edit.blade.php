...
@section('title', 'Edit Bahan Baku – ' . $bahanBaku->nama_bahan_baku)
...
<div class="container">
    ...
    <div class="ph-card">
        <div class="ph-left">
            ...
            <div>
                <h5 class="ph-title">Edit Bahan Baku</h5>
        ...
        <div class="col-lg-8">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <form action="{{ route('bahan-baku.update', $bahanBaku->id) }}" method="POST" novalidate>
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            <div class="col-md-5">
                                ...
                                <input type="text" name="kode_bahan_baku" autofocus
                                    ...
                                    value="{{ old('kode_bahan_baku', $bahanBaku->kode_bahan_baku) }}" required>
                            ...
                            <div class="col-md-7">
                                ...
                                <input type="text" name="nama_bahan_baku"
                                    ...
                                    value="{{ old('nama_bahan_baku', $bahanBaku->nama_bahan_baku) }}" required>
                                ...
                                <select name="kategori_barang_id"
                                    ...
                                    @foreach ($kategoris as $kategori)
                                        <option value="{{ $kategori->id }}"
                                            @selected(old('kategori_barang_id', $bahanBaku->kategori_barang_id) == $kategori->id)>
                                ...
                                <select name="satuan_id"
                                    ...
                                    @foreach ($satuans as $satuan)
                                        <option value="{{ $satuan->id }}"
                                            @selected(old('satuan_id', $bahanBaku->satuan_id) == $satuan->id)>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" readonly
                                    value="{{ rtrim(rtrim(number_format($bahanBaku->stok_saat_ini, 2, ',', '.'), '0'), ',') }}">
                                <div class="form-text" style="font-size:.75rem;">
                                    Nilai cache otomatis dari penerimaan bahan baku, tidak bisa diubah manual di sini.
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" min="0" name="stok_minimum"
                                    ...
                                    value="{{ old('stok_minimum', $bahanBaku->stok_minimum) }}" required>
                            ...
                            <div class="col-md-12">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" role="switch"
                                        ...
                                        @checked(old('is_aktif', $bahanBaku->is_aktif))>
