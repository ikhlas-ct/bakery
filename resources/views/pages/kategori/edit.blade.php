...
@section('title', 'Edit Kategori Barang – ' . $kategoriBarang->nama_kategori)
...
<div class="container">
    ...
    <div class="ph-card">
        <div class="ph-left">
            ...
            <div>
                <h5 class="ph-title">Edit Kategori Barang</h5>
                <ol class="ph-breadcrumb">
                    <li><a href="{{ $dashboardRoute }}">Dashboard</a></li>
                    <li><a href="{{ route('kategori-barang.index') }}">Kategori Barang</a></li>
                    <li><span class="bc-active">Edit</span></li>
                </ol>
            </div>
        </div>
        <a href="{{ route('kategori-barang.index') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="col-lg-6">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <form action="{{ route('kategori-barang.update', $kategoriBarang->id) }}" method="POST" novalidate>
                        @csrf
                        @method('PUT')

                        <div class="mb-3">
                            <label class="form-label">Nama Kategori <span class="required-mark">*</span></label>
                            <input type="text" name="nama_kategori" autofocus
                        ...
                        <div class="d-flex gap-2 mt-4">
                            ...
                            <a href="{{ route('kategori-barang.index') }}" class="btn btn-outline-secondary flex-fill">
                                Batal
                            </a>
                        </div>
                    </form>
