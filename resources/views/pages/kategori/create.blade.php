...
<div class="container">
    ...
    <div class="ph-card">
        <div class="ph-left">
            ...
            <div>
                <h5 class="ph-title">Tambah Kategori Barang</h5>
        ...
        <div class="col-lg-6">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <form action="{{ route('kategori-barang.store') }}" method="POST" novalidate>
                        @csrf
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nama_kategori" autofocus
                                ...
                                value="{{ old('nama_kategori') }}" placeholder="Contoh: Tepung, Gula, Susu"
                                required>
