    ...
    <div class="container">
        ...
        <div class="ph-card mb-4">
            <div class="ph-left">
                ...
                <div>
                    <h5 class="ph-title">Data Satuan</h5>
                    <ol class="ph-breadcrumb mb-0">
                        <li><a href="{{ $dashboardRoute }}">Dashboard</a></li>
                        <li><span class="bc-active">Satuan</span></li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-6 col-md-4">
                <div class="stat-card blue">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <div class="stat-value">{{ $totalSatuan }}</div>
            ...
            <div class="col-6 col-md-4">
                <div class="stat-card green">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <div class="stat-value">{{ $satuanTerpakai }}</div>
            ...
            <div class="col-6 col-md-4">
                <div class="stat-card orange">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <div class="stat-value">{{ $satuanBelumTerpakai }}</div>
        ...
        <div class="card filter-card">
            ...
            <div class="card-header d-flex align-items-center justify-content-between flex-wrap gap-2">
                <h5 class="mb-0"><i class="fas fa-list text-primary me-2"></i>Daftar Satuan</h5>
                <span class="text-muted" style="font-size:.78rem;">{{ $satuans->total() }} data ditemukan</span>
            </div>
                ...
                <form method="GET" action="{{ route('satuan.index') }}" class="row g-2 align-items-end">
                    <div class="col-md-8 col-sm-8">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="text" name="search" class="form-control border-start-0 ps-0"
                                style="border-radius:0 10px 10px 0;" placeholder="Cari nama atau kode satuan…"
                    ...
                    <div class="col-md-auto d-flex gap-2">
                        ...
                        @if (request()->hasAny(['search']))
                            <a href="{{ route('satuan.index') }}" class="btn btn-outline-secondary btn-sm px-3">
                ...
                <table class="table">
                    ...
                    <tbody>
                        @forelse ($satuans as $i => $satuan)
                            <tr>
                                <td class="text-muted">{{ $satuans->firstItem() + $i }}</td>
                                <td><span class="name-text">{{ $satuan->nama }}</span></td>
                                <td>
                                    @if ($satuan->kode_satuan)
                                        <span class="badge-kode">{{ $satuan->kode_satuan }}</span>
                                    @else
                                ...
                                <td>
                                    @if ($satuan->bahan_bakus_count > 0)
                                        <span class="badge-count">{{ $satuan->bahan_bakus_count }} bahan baku</span>
                                    @else
                                ...
                                <td>
                                    <div class="d-flex gap-1">
                                        ...
                                        <button class="btn btn-action btn-hapus" data-id="{{ $satuan->id }}"
                                            data-nama="{{ $satuan->nama }}" title="Hapus">
                                            <i class="fas fa-trash-alt"></i>
                                        </button>
                                        <form id="form-hapus-{{ $satuan->id }}"
                            ...
                            <tr>
                                <td colspan="5" class="p-0 text-center">
                                    <div class="empty-state">
                                        <div class="empty-state-icon"><i class="fas fa-ruler-combined"></i></div>
                                        <div class="fw-semibold text-secondary mb-1">Belum ada data satuan</div>
            ...
            @if ($satuans->hasPages())
                <div class="card-footer d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <small class="text-muted">
                        Menampilkan
                        <strong>{{ $satuans->firstItem() }}</strong>–<strong>{{ $satuans->lastItem() }}</strong>
                        dari <strong>{{ $satuans->total() }}</strong> data
                    </small>
                    {{ $satuans->links() }}
                </div>
            @endif
